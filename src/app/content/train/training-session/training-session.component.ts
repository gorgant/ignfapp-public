...
import { AddTrainingSessionToPersonalQueueButtonComponent } from 'src/app/shared/components/add-training-session-to-personal-queue-button/add-training-session-to-personal-queue-button.component';
import { AddTrainingSessionToPlanButtonComponent } from 'src/app/shared/components/add-training-session-to-plan-button/add-training-session-to-plan-button.component';
